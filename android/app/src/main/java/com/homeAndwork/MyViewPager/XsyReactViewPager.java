...
/**
 * Created by chaoye on 2017/5/24.
 */

public class XsyReactViewPager extends ViewPager {
    ...
    private class PageChangeListener implements OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            mEventDispatcher.dispatchEvent(
                    new XsyPageScrollEvent(getId(), position, positionOffset));
        }
        ...
        public void onPageSelected(int position) {
            if (!mIsCurrentItemFromJs) {
                mEventDispatcher.dispatchEvent(
                        new XsyPageSelectedEvent(getId(), position));
            }
        }
        ...
        public void onPageScrollStateChanged(int state) {
            ...
            mEventDispatcher.dispatchEvent(
                    new XsyPageScrollStateChangedEvent(getId(), pageScrollState));
        }
    }
    ...
    public XsyReactViewPager(ReactContext reactContext) {
        super(reactContext);
        mEventDispatcher = reactContext.getNativeModule(UIManagerModule.class).getEventDispatcher();
        mIsCurrentItemFromJs = false;
        setOnPageChangeListener(new XsyReactViewPager.PageChangeListener());
        setAdapter(new XsyReactViewPager.Adapter());
    }

    @Override
    public XsyReactViewPager.Adapter getAdapter() {
        return (XsyReactViewPager.Adapter) super.getAdapter();
    }
