 ...
 */
class XsyPageScrollStateChangedEvent extends Event<XsyPageScrollStateChangedEvent> {

  public static final String EVENT_NAME = "topPageScrollStateChanged";

  private final String mPageScrollState;

  protected XsyPageScrollStateChangedEvent(int viewTag, String pageScrollState) {
    super(viewTag);
